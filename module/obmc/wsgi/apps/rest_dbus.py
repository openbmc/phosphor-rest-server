...
class ImageUploadUtils:
    ...
    def software_interfaces_added_handler(self, path, iprops, **kw):
        ...
        def do_clear_version_id_q():
            ''' Pop an element out the version id queue '''
        ...
        if ImageUploadUtils.version_id != version_id:
            ...
            # Schedule it to start after the version loop counter from
            # do_check_version() expires.
            threading.Timer(15, do_clear_version_id_q).start()
